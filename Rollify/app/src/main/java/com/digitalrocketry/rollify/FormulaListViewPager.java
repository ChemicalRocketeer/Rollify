...
public class FormulaListViewPager extends ViewPager {
    ...
    public FormulaListViewPager(Context context) {
        this(context, null);
    }

    public FormulaListViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);

        setAdapter(mStaticPagerAdapter);
        addOnPageChangeListener(mOnPageChangeListener);
        setPageMargin(-getResources().getDimensionPixelSize(R.dimen.padPageMargin));
